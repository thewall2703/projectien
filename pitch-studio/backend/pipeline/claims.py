...
CLAIMS_RULES_PROMPT = (
    ...
    "Numbers come from LOCKED facts / REPORT EVIDENCE, or from the SELECTED SLIDES listed "
    "for the beat (the labels are what the audience can see).\n"
    ...
    "5. SLIDE WINS ON CONFLICT — if a selected slide's label/title states a figure and LOCKED, "
    "REPORT, or a transcript states a different figure for the same claim, speak the figure on "
    "the slide for that beat. Do not say a competing number while that slide is up. Use the "
    "LOCKED/REPORT figure only on beats where no selected slide shows a conflicting number.\n"
